...
- Google Fonts
- Propriedades de background (background-color, background-image, background-size, background-position)
- Gradientes CSS (linear e radial)
...
- Aplicação correta das propriedades de background
- Criatividade na utilização de gradientes
...
4. Verifique se está tudo correto no seu repositório do GitHub
